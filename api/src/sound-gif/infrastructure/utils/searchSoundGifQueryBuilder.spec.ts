...
describe('searchSoundGifQuery', () => {
  ...
  it.each([
    [
      undefined,
      undefined,
      { queryBuilder: 1, where: 0, andWhere: 0, getMany: 1 },
    ],
    [undefined, 'tags', { queryBuilder: 1, where: 0, andWhere: 1, getMany: 1 }],
    [
      { category: 'sport' },
      undefined,
      { queryBuilder: 1, where: 1, andWhere: 0, getMany: 1 },
    ],
    [
      { category: 'sport' },
      'zidane',
      { queryBuilder: 1, where: 1, andWhere: 1, getMany: 1 },
    ],
  ])(
